...
<html class="js" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="stylesheet" href="./jquery.min.js_files/typesense-minibar.css">
	<link rel="stylesheet" href="./jquery.min.js_files/base.css">
	<link rel="stylesheet" href="./jquery.min.js_files/style.css">

	<script src="./jquery.min.js_files/jquery-4.0.0.min.js"></script>
	<script src="./jquery.min.js_files/main.js"></script>
	<script defer="" type="module" src="./jquery.min.js_files/typesense-minibar.js"></script>
...
<link rel="https://api.w.org/" href="https://jquery.com/wp-json/"><link rel="alternate" title="JSON" type="application/json" href="https://jquery.com/wp-json/wp/v2/pages/8"><meta name="generator" content="WordPress 6.9.4">
...
<li class="menu-item"><a href="https://jquery.com/support/">Version Support</a></li>
	...
	<input type="search" name="s" aria-label="Search jQuery" value="" placeholder="Search" autocomplete="off"><div role="listbox" hidden=""></div>
	<button type="submit" class="visuallyhidden"></button>
<svg viewBox="0 0 12 12" width="20" height="20" aria-hidden="true" tabindex="-1" class="tsmb-icon-close"><path d="M9 3L3 9M3 3L9 9"></path></svg></form>
</typesense-minibar>
	</nav>
...
<div id="banner-secondary" class="row">
	<div class="download four columns push-eight">
		...
		<div class="download-options">
			...
			<a href="https://jquery.com/support">Discover Support Options</a>
				...
				<ul class="books">
					<li>
						<a href="https://www.packtpub.com/en-us/product/learning-jquery-fourth-edition-9781782163152">
							<img src="./jquery.min.js_files/learning-jquery-4th-ed.jpg" alt="Learning jQuery 4th Edition by Karl Swedberg and Jonathan Chaffer" width="92" height="114" loading="lazy">
					...
					<li>
						<a href="https://www.manning.com/books/jquery-in-action-third-edition">
							<img src="./jquery.min.js_files/jquery-in-action.jpg" alt="jQuery in Action by Bear Bibeault, Yehuda Katz, and Aurelio De Rosa" width="92" height="114" loading="lazy">
							jQuery in Action
					...
					<li>
						<a href="https://www.syncfusion.com/ebooks/jquery">
							<img src="./jquery.min.js_files/jquery-succinctly.jpg" alt="jQuery Succinctly by Cody Lindley" width="92" height="114" loading="lazy">
							jQuery Succinctly
